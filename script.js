const perguntas = [
    ...
    },
    {
        ...
        alternativas: [
            { texto: "Sim, deveria ser obrigatório..", pontuacao: 0 },
            { texto: "Não, não deveria ser obrigatório.", pontuacao: 3 }
        ]
    },
    {
        enunciado: "A pena de morte deve ser uma opção para crimes hediondos?",
        alternativas: [
            { texto: "Sim, deve ser aplicada dependendo do caso", pontuacao: 3 },
    ...
    },
    {
        ...
        alternativas: [
            { texto: "Sim, deve ser reconhecido.", pontuacao: 5 },
            { texto: "Não, deve ser abolida.", pontuacao: 0 }
        ]
    }
];
